            ...
            <div id="wp-products">
                ...
                <div class="filter-all">
                    ...
                    <div class="btn-group dropend">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">Theo a-z</a></li>
                            <li><a class="dropdown-item" href="#">Theo b-c</a></li>
                            <li><a class="dropdown-item" href="#"><b>Bán chạy</b><i class="fas fa-fire"></i></a></li>
                        </ul>
                    </div>
                </div>
                <hr />
